<template>
	<div id="app">
		<header class="header" v-if="showAnswer">
			<value />
		</header>
		<div class="container" ref="canvas">
			<transition name="fade" mode="out-in" appear>
				<div v-if="!showAnswer" key="button">
...
<script>
const answer = () =>
	import(/* webpackChunkName: "answer" */ './components/Answer.vue').then(c => c.default);
const value = () =>
	...
	methods: {
		share(element) {
			html2canvas(element).then(canvas => {
				...
				link.download = 'magic-8-ball.png';
